...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var headerView = AccountHeaderView(this).apply {
            ...
            addProfiles(
                ProfileDrawerItem().apply { nameText = "Emtnan Ahmed"; descriptionText = "emtnanbg@gmail.com"; iconRes = R.drawable.ic_baseline_person_24; identifier = 102 }
            )
